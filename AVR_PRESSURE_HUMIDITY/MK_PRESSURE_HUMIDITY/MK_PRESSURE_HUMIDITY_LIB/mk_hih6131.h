...
extern uint8_t hih6131_init( void );

extern uint8_t hih6131_read_temp( int8_t * at_int, uint8_t * at_fract );
extern uint8_t hih6131_read_humidity( uint8_t * hm_int, uint8_t * hm_fract );
