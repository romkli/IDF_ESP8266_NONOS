...
extern uint8_t bmpe280_init( void );
extern uint8_t bmpe280_read_temp( int8_t * at_int, uint8_t * at_fract );
extern uint8_t bmpe280_read_pressure( uint16_t * hp_int, uint8_t * hp_fract );
extern uint8_t bmpe280_read_humidity( uint8_t * hm_int, uint8_t * hm_fract );
