...
static uint8_t ICACHE_FLASH_ATTR bmpe280_read_byte( uint8_t addr ) {
...
static uint16_t ICACHE_FLASH_ATTR bmpe280_read_word( uint8_t addr ) {
...
static uint32_t ICACHE_FLASH_ATTR bmpe280_read_3bytes( uint8_t addr ) {
...
static uint16_t ICACHE_FLASH_ATTR bmpe280_read_uint16( uint8_t reg ) {

    uint16_t temp = bmpe280_read_word( reg );
    return (temp >> 8) | (temp << 8);
}

static int16_t ICACHE_FLASH_ATTR bmpe280_read_int16( uint8_t reg ) {

    return (int16_t)bmpe280_read_uint16( reg );
}


static void ICACHE_FLASH_ATTR bme280_readCoefficients( void ) {
...
uint8_t ICACHE_FLASH_ATTR bmpe280_init( void ) {
...
uint8_t ICACHE_FLASH_ATTR bmpe280_read_temp( int8_t * at_int, uint8_t * at_fract ) {
...
uint8_t ICACHE_FLASH_ATTR bmpe280_read_pressure( uint16_t * hp_int, uint8_t * hp_fract ) {
...
uint8_t ICACHE_FLASH_ATTR bmpe280_read_humidity( uint8_t * hm_int, uint8_t * hm_fract ) {
