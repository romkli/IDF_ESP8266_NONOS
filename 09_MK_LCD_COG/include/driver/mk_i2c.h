...
#define aBITRATE_100KHZ		0
#define aBITRATE_200_400KHZ	1	// dla F_CPU=80MHz bitrate = 190 kHz, dla FCPU=160MHz bitrate = 380kHz
#define aBITRATE_260_600KHZ	2	// dla F_CPU=80MHz bitrate = 260 kHz, dla FCPU=160MHz bitrate = 580kHz
